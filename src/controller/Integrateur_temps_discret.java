...
public class Integrateur_temps_discret {
	private ArrayList<Block> components; // List of components

	public Integrateur_temps_discret() {
	...
	public void run() {
		...
		while (t <= tEnd) {
			...
			ci.addDataToSeries(t, ((DTI) components.get(5)).getX());
