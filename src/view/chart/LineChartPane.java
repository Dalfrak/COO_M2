...
import view.table.TableModelChart;
...
public class LineChartPane extends JSplitPane implements ActionListener, Observer {
	...
	public LineChartPane(String titre, String legende) {
		...
		// Generate the graph
		chart = ChartFactory.createXYLineChart(titre, // Title
	...
	/**
	 * Cette méthode permet d'informer un changement de la donnée afin de procéder à
	 * une mise à jours
	 */
	public void fireDataChanged() { chart.fireChartChanged(); }
	 ...
	 * @param titre titre
	 */
	public void updateTitre(String titre) { chart.setTitle(titre); }
	...
	/**
	 * Cette méthode permet de changer la forme de la courbe soit mode lisse,
	 * escalier ou Spline
	 * 
	...
	public void actionPerformed(ActionEvent event) {
		...
		} else if (event.getActionCommand().equals("Spline")) { changeRenderer(this.Spline_Renderer_KEY); }

	}

	public XYSeriesCollection getDataset() { return dataset; }

	public void addDataset(XYSeries s) { dataset.addSeries(s); }

	public void removeDataset(XYSeries s) { dataset.removeSeries(s); }

	public void clearDataset() { dataset.removeAllSeries(); }
	...
	/**
	 * Cette méthode permet de faire une mise à jour de courbes à afficher dans le
	 * panneau d'affichage des courbes
	 * 
